...
export default function AccentIcons({ type = 'star', size = 'md', className = '' }: AccentIconsProps) {
  ...
  const icons = {
    ...
    ornament: (
      <svg className={`${sizeClass} text-primary-red opacity-60 transition-all duration-300 hover:opacity-100 hover:scale-110 ${className}`} fill="currentColor" viewBox="0 0 20 20">
